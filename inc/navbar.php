...
<nav class="flex items-center justify-between py-2 px-8 bg-white border-b border-gray-100">
    <div class="flex items-center gap-2 relative ml-10">
        ...
        <div class="flex items-center ml-3">
            <img src="../assets/HuellaNav.png" class="w-7 h-7 transition-opacity duration-200 opacity-80" alt="huella">
            <img src="../assets/HuellaNav.png" class="w-7 h-7 transition-opacity duration-200 opacity-60 -ml-2" alt="huella">
            <img src="../assets/HuellaNav.png" class="w-7 h-7 transition-opacity duration-200 opacity-50 -ml-2" alt="huella">
            <img src="../assets/HuellaNav.png" class="w-7 h-7 transition-opacity duration-200 opacity-40 -ml-2" alt="huella">
        </div>
    </div>
    <div class="flex gap-8 ml-8">
        ...
        <a href="#" class="text-purple-text font-medium text-base hover:text-purple-main transition-colors duration-200">Adoptar</a>
