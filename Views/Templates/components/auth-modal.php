    ...
    <div class="flex flex-col md:flex-row">
      ...
      <div class="md:w-1/2 bg-gradient-to-br from-purple-50 to-pink-50 p-8 flex flex-col items-center justify-center relative">
        <div class="text-center">
          ...
          <div class="mb-4">
            <img src="<?php echo BASE_URL; ?>assets/images/home/registroCachorro.webp" alt="Puppy" class="w-48 h-48 object-cover rounded-lg">
          </div>
    ...
    <div class="flex flex-col md:flex-row-reverse">
      ...
      <div class="md:w-1/2 bg-gradient-to-br from-purple-50 to-pink-50 p-8 flex flex-col items-center justify-center relative">
        <div class="text-center">
          ...
          <div class="mb-4">
            <img src="<?php echo BASE_URL; ?>assets/images/home/registroCachorro.webp" alt="Cat" class="w-48 h-48 object-cover rounded-lg">
